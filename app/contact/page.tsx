              ...
              >
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-serif font-bold text-black mb-1">Phone</h3>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-serif font-bold text-black mb-1">Email</h3>
                      <p className="text-gray-600">info@luxuryresort.com</p>
                      <p className="text-gray-600">reservations@luxuryresort.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-serif font-bold text-black mb-1">Address</h3>
                      <p className="text-gray-600">123 Paradise Beach Road</p>
                      <p className="text-gray-600">Island Paradise 12345</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-serif font-bold text-black mb-1">Hours</h3>
